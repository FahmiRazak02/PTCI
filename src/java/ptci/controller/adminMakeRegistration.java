 ...
 * @author HP
 */
public class adminMakeRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet adminMakeRegistration</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet adminMakeRegistration at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (choice.equals("student")) {
            ...
            if (!error_messages.isEmpty()) {
                ...
                out.println("location='makeRegistration.jsp';");
                out.println("</script>");
                return;
            }
